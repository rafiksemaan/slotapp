...
$allowed_actions = ['list', 'upload', 'delete_upload'];
...
switch ($action) {
        ...
        <div class="import-transactions-page fade-in">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="index.php?page=import_transactions&action=upload" method="POST" enctype="multipart/form-data" id="importTransactionsForm">
    ...
    case 'delete_upload':
        ...
        include 'import_transactions/delete.php';
        break;
